    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-20 bg-gray-950 text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-5xl font-black" style={{fontFamily:"Georgia,serif"}}>Technology at<br />Janapriya Upscale</h1>
      ...
      <section className="py-20 max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <h2 className="text-4xl font-black text-gray-900 mb-5" style={{fontFamily:"Georgia,serif"}}>AI-Powered Smart Homes</h2>
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-black text-gray-900" style={{fontFamily:"Georgia,serif"}}>Our Technology Stack</h2>
        </div>
        ...
        <div className="bg-gray-950 rounded-3xl p-10 md:p-16 text-center text-white">
          ...
          <h2 className="text-4xl font-black mb-4" style={{fontFamily:"Georgia,serif"}}>JP Digital Platform</h2>
